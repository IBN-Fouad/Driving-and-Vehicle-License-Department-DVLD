...
namespace DVLD_MySolution.Applications.NewFolder1
{
    public partial class frmAddUpdateLocalDrivingLicesnseApplication : Form
    {
        ...
        private void _ResetDefualtValues()
        {
            ...
            {
                lblTitle.Text = "New Loceal Driving License Application";
                this.Text = "New Loceal Driving License Application";
        ...
        private void _LoadData()
        {
            ...
            cbLicenseClass.SelectedIndex = cbLicenseClass.FindString(clsLicenseClass.Find(_LocalDrivingLicenseApplication.LicensesClassID).ClassName);
            lblFees.Text = _LocalDrivingLicenseApplication.PaidFees.ToString();
            lblCreatedByUser.Text=clsUser.FindByPersonID(_LocalDrivingLicenseApplication.CreatedByUserID).UserName;
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            int
                ...
                ActiveApplicationID = clsApplication.GetActiveApplicationIDForLicenseClass(_SelectedPersonID, clsApplication.enApplicationType.NewDrivingLicense, LicenseClassID);
            ...
            _LocalDrivingLicenseApplication.LicensesClassID = LicenseClassID;
