...
namespace DVLD_MySolution.People
{
    public partial class frmAddUpdatePerson : Form
    {
        ...
        private void _LoadData()
        {
            ...
            //The following code will not bo executed if the person was not found
        ...
        private bool _HandlePersonImage()
        {
            ...
            if(_Person.ImagePath != pbPersonImage.ImageLocation)
            {
                if(_Person.ImagePath != "")
                {
                    //first we delete the old image from the folders in case there in any.
                    try
                    {
                ...
                {
                    //Then we coby the new image to the image folder after we rename it
        ...
        {
            //First: set AutoValidate property of your From to EnableAllowFocusChange in designer
        ...
        private void txtNationalNo_Validating(object sender, CancelEventArgs e)
        {
            ...
            //Make sure the national is not used by another person
